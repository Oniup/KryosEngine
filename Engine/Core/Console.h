...
// OpenGL
// ------------------------------------------------------------------------------------------------
#define OPENGL_VERBOSE(...) CONTEXT_VERBOSE("OPENGL", __VA_ARGS__)
#define OPENGL_TRACE(...)   CONTEXT_TRACE("OPENGL", __VA_ARGS__)
#define OPENGL_INFO(...)    CONTEXT_INFO("OPENGL", __VA_ARGS__)
#define OPENGL_WARN(...)    CONTEXT_WARN("OPENGL", __VA_ARGS__)
#define OPENGL_ERROR(...)   CONTEXT_ERROR("OPENGL", __VA_ARGS__)
#define OPENGL_FATAL(...)   CONTEXT_FATAL("OPENGL", __VA_ARGS__)

#define OPENGL_WARN_RETURN(_returning, ...) CONTEXT_WARN_RETURN("OPENGL", _returning, __VA_ARGS__)
#define OPENGL_ERROR_RETURN(_returning, ...) \
    CONTEXT_ERROR_RETURN("OPENGL", _returning, __VA_ARGS__)
#define OPENGL_FATAL_RETURN(_returning, ...) \
    CONTEXT_ERROR_RETURN("OPENGL", _returning, __VA_ARGS__)

#define OPENGL_CONDITION_WARN(_condition, ...) \
    CONTEXT_CONDITION_WARN("OPENGL", _condition, __VA_ARGS__)
#define OPENGL_CONDITION_ERROR(_condition, ...) \
    CONTEXT_CONDITION_ERROR("OPENGL", _condition, __VA_ARGS__)
#define OPENGL_CONDITION_FATAL(_condition, ...) \
    CONTEXT_CONDITION_FATAL("OPENGL", _condition, __VA_ARGS__)

#define OPENGL_CONDITION_WARN_RETURN(_condition, _returning, ...) \
    CONTEXT_CONDITION_WARN_RETURN("OPENGL", _condition, _returning, __VA_ARGS__)
#define OPENGL_CONDITION_ERROR_RETURN(_condition, _returning, ...) \
